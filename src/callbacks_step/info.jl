...
info_callback(u, t, integrator) = false # when used as condition; never call the summary callback during the simulation
info_callback(integrator) = u_modified!(integrator, false) # the summary callback does nothing when called accidentally
...
function initialize_info_callback(cb::DiscreteCallback, u, t, integrator;
    ...
    if callbacks isa CallbackSet
        ...
        foreach(callbacks.discrete_callbacks) do cb
            ...
            cb.affect! === info_callback && return nothing
