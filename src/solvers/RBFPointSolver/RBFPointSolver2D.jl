...
# the RHS etc.
function create_cache(mesh::PointCloudDomain{2}, equations,
                      dg::DG, RealT, uEltype)
...
function create_cache(mesh::Union{PointCloudDomain{2}, StructuredMesh{2},
                                  UnstructuredMesh2D,
...
@inline function weak_form_kernel!(du, u,
                                   element, mesh::PointCloudDomain{2},
...
@inline function calcflux_fv!(fstar1_L, fstar1_R, fstar2_L, fstar2_R,
                              ...
                              mesh::PointCloudDomain{2}, nonconservative_terms::False,
                              equations,
...
@inline function calcflux_fv!(fstar1_L, fstar1_R, fstar2_L, fstar2_R,
                              u::AbstractArray{<:Any, 4},
                              mesh::PointCloudDomain{2}, nonconservative_terms::True,
                              equations,
                              volume_flux_fv, dg::DGSEM, element, cache)
...
function prolong2interfaces!(cache, u,
                             mesh::PointCloudDomain{2}, equations, surface_integral,
                             dg::DG)
...
function prolong2mortars!(cache, u,
                          mesh::PointCloudDomain{2}, equations,
...
function calc_surface_integral!(du, u,
                                mesh::Union{PointCloudDomain{2}, StructuredMesh{2}},
...
function apply_jacobian!(du, mesh::PointCloudDomain{2},
